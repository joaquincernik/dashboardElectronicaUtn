...
/**
 * Class ComponenteCrudController
...
class ComponenteCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Componente::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/componente');
        CRUD::setEntityNameStrings('componente', 'componentes');
    }

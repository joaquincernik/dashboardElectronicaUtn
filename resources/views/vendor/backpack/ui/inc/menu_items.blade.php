...
<x-backpack::menu-item title="Inventario" icon="la la-question" :link="backpack_url('inventario')" />
<x-backpack::menu-item title="Usuarios" icon="la la-question" :link="backpack_url('persona')" />
<x-backpack::menu-item title="Persona externas"  icon="la la-question" :link="backpack_url('persona-externa')" />
<x-backpack::menu-item title="Cursos" icon="la la-question" :link="backpack_url('curso')" />
...
-->
<x-backpack::menu-item title="Ventas" icon="la la-question" :link="backpack_url('venta')" />
<x-backpack::menu-item title="Compras" icon="la la-question" :link="backpack_url('compra')" />
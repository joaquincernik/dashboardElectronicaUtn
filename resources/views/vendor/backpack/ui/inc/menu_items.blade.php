...
<x-backpack::menu-item title="Cuota socios" icon="la la-user text-success" :link="backpack_url('cuota-socio')" />
...
<x-backpack::menu-item title="Balances" icon="la la-money text-success" :link="backpack_url('balance')" />